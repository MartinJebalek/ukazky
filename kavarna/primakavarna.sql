...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pát 24. úno 2023, 16:35
...
--
CREATE DATABASE IF NOT EXISTS `primakavarna` DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci;
USE `primakavarna`;
