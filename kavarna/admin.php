...
if (array_key_exists("prihlasenyUzivatel", $_SESSION))
{
    ...
    if (array_key_exists("ulozit", $_POST))
    {
        ...
        // presmerujeme se na url s editaci stranky s novym id (kdyby se id zmenilo tak nesmime zustat na puvodni url)
    ...
    if (array_key_exists("poradi", $_GET))
    {
        ...
        echo "OK";
        // skript ukoncime aby do javascriptu se negeneroval zbytek html stranky
        exit;
    }
}
?>
            ...
            <main class="form-signin">
                <form method="post">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="floatingInput">Přihlašovací jméno (admin)</label>
                    </div>
                    <div class="form-floating">
                        <input name="heslo" type="password" class="form-control" id="floatingPassword" placeholder="heslo">
                        <label for="floatingPassword">Heslo (1234)</label>
                    </div>
        ...
        else
        {
            ...
            if ($instanceAktualniStranky != null)
            {
                ...
                <form method="post">
                    ...
                    <div class="form-floating">
                        <input class="form-control" type="text" name="titulek" id="titulek" placeholder="Titutlek"
                            value="<?php echo htmlspecialchars($instanceAktualniStranky->titulek) ?>">
                        <label for="titulek">Titulek</label>
                    </div>
                    <div class="form-floating">
                        <input class="form-control" type="text" name="menu" id="menu" placeholder="Menu"
